package com.plumery.apicurio.core.testcontainers
...
class ApicurioSchemaRegistryContainerFactory {
  static GenericContainer makeAndStartContainer(String containerName = "apicurio-schema-registry", Integer httpPort = 8080) {
    ...
    GenericContainer apicurioSchemaRegistry = new GenericContainer(DockerImageName.parse("apicurio/apicurio-registry-mem").withTag("2.6.8.Final"))
